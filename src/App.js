...
function App() {
  return (
    <div className="App">
      ...
      <p style={{ fontSize : '25px',color:'#0c0049', padding: '50px'}}> Our vision is to be the preferred training services provider across the globe.
      ...
      <section id="mission" style={{
        ...
        <h2 style={{ fontFamily: 'Pacifico, cursive', fontSize: '2.5rem', fontWeight: '900' }}>
          We are Listening.
        </h2>
        <blockquote style={{
