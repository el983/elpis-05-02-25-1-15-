...
function MovingContainer1() {
  ...
  return (
    <div ref={sectionRef} className="moving-section">
      <h2 className="section-title-head">Corporate Training</h2>
      <div style={{ height: "10vh" }}></div>
      <motion.div
...
function MovingContainer2() {
  ...
  return (
    <div ref={sectionRef} className="moving-section">
      <h2 className="section-title-head">Leadership Program</h2>
      <div style={{ height: "10vh" }}></div>
      <motion.div
        className="moving-container"
        animate={{
...
function MovingContainer3() {
  ...
  return (
    <div ref={sectionRef} className="moving-section">
      <h2 className="section-title-head">Training Program For Executives</h2>
      <div style={{ height: "10vh" }}></div>
      <motion.div
        className="moving-container"
        animate={{
...
function MovingContainer4() {
  ...
  return (
    <div ref={sectionRef} className="moving-section2">
      <h2 className="section-title-head">Student Training (HEI)</h2>
      <div style={{ height: "20vh" }}></div>
      <div style={{ height: "80vh", zIndex:'100' }}>
      <motion.div
        className="moving-container"
        animate={{
          x: -scrollProgress * 40, // Moves left within section
          y: -scrollProgress * 800, // Moves up within section
        }}
        transition={{ type: "spring", stiffness: 100, damping: 15 }}
      >
        <div><h3 className="section-title"> Personality Development Program (PDP) </h3>
