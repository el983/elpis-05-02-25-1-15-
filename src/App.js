  ...
  return (
    <div className="App">
      ...
      <section id="mission" style={{
          ...
          <h3 style={{fontFamily: ' "Arial", sans-serif', fontSize: '2.5rem',
          fontWeight: '200',}}>Are you ready to open the door to a new level of empowerment?<br/> We are Listening. </h3>
