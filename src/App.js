...
function App() {
  return (
    <div className="App">
      ...
      <br></br>
      <h2>Vision</h2>
      <p> Our vision is to be the preferred training services provider across the globe.
      ...
      <div class="container">
        ...
        <section id="mission">
          ...
          fontWeight: 'bold',}}>“Training is a catalyst that can transform lives, companies, and even nations.”</blockquote>
        </section>
      </div>
